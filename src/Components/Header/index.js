  ...
  return (
    <header className="container mx-auto my-2">
      <div className="flex items-center justify-between">
        <img className="md:w-[14%] w-[30%] " src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png" alt="Logo" />

        <div className="md:flex hidden w-[82%] justify-between items-center">
        ...
        <div className="flex md:hidden items-center gap-2">
            <img className="w-[35px] h-[35px] rounded-full" src="https://b.zmtcdn.com/images/user_avatars/mug_2x.png?fit=around%7C100%3A100&crop=100%3A100%3B%2A%2C%2A" alt="Mug" />
            <h3 className="font-semibold text-slate-600">Mosabbir</h3>
            <AiOutlineDown className="btn text-slate-600" size={15} />
          </div>
